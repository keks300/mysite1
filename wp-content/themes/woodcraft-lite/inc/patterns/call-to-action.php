 ...
 */
return array(
	'title'      => __( 'Call to Action Center Text', 'woodcraft-lite' ),
	...
	<div class="wp-block-buttons"><!-- wp:button {"width":25,"style":{"color":{"background":"#000000"}}} -->
	<div class="wp-block-button has-custom-width wp-block-button__width-25"><a class="wp-block-button__link has-background" href="tel: +91 2456 254 256" style="background-color:#000000">'.esc_html('Call Us Now').'</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->',
